...
void main() {
  test('PocketBase remoteSearch throws when offset provided without limit', () async {
  ...
  test('PocketBase remoteSearch throws on invalid updatedAt value type', () async {
    final client = PocketBase('http://localhost');
    final store = PocketBaseRemoteStore<MapRecord, String>(
      config: PocketBaseRemoteConfig<MapRecord, String>(
        client: client,
  ...
  test('PocketBase remoteSearch throws when offset is not a multiple of limit', () async {
    final client = PocketBase('http://localhost');
    final store = PocketBaseRemoteStore<MapRecord, String>(
      config: PocketBaseRemoteConfig<MapRecord, String>(
        client: client,
